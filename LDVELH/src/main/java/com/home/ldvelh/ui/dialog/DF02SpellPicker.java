...
public class DF02SpellPicker extends Store<Spell>implements Observer {
	...
	@Override protected void addToList(ShopPickerItem shopItem, ListValueHolder<Spell> list) {
	...
	@Override protected boolean okButtonEnabled(IntValueHolder currency) {
